    ...
    <section id="home-section" className="h-dvh grid place-content-center">
      <div className="px-5 grid grid-cols-1 lg:grid-cols-2 grid-rows-3 lg:grid-rows-2 lg:gap-x-20">
        <div className="font-family-oswald col-start-1 row-start-1 flex justify-center lg:justify-start items-end select-none">
          <span id="first-title" className="text-8xl lg:text-[14rem] whitespace-nowrap line-through tracking-wide leading-none">Lorem</span>
        </div>
        ...
        <div className="font-family-oswald lg:col-span-2 col-start-1 row-start-2 flex justify-center lg:justify-start items-start select-none text-center lg:text-left">
          <span id="second-title" className="text-8xl lg:text-[14rem] lg:whitespace-nowrap line-through tracking-wide leading-none pb-5 md:pb-0">ipsum dolor</span>
        </div>
      </div>
    </section>
  )
